...
<template>
    <el-row class="login-page">
        ...
        <el-col :span="6" :offset="3" class="form">
            <!-- 注册表单 -->
            <el-form ref="form" size="large" autocomplete="off" :model="registerData" v-if="isRegister" :rules="registerDataRules">
                <el-form-item>
                    <h1>注册</h1>
                </el-form-item>
            ...
            <!-- 登录表单 -->
            <el-form ref="form" size="large" autocomplete="off" v-else :model="loginData" :rules="loginDataRules">
                <el-form-item>
                    <h1>登录</h1>
                </el-form-item>
                <el-form-item prop="username">
...
.login-page {
    ...
    .bg {
        background: url('@/assets/title.png') no-repeat 50% center / 240px auto,
